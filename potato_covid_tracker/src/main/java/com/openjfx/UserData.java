...
public class UserData {
    ...
    public static int createNewUser2(int userID, String firstname, String lastname, String gender, String dose,
            String vaccinatedDate, String profileName) throws IOException {
        List<String> lines = new ArrayList<String>();
        String line = null;
        File f1 = new File("userInfo.txt");
        FileReader fr = new FileReader(f1);
        ...
        FileWriter fw = new FileWriter(f1);
        BufferedWriter out = new BufferedWriter(fw);
        out.write(userID + " " + getNewestUsername() + " " + firstname + " " + lastname + " " + gender + " " + dose
                + " " + vaccinatedDate + " " + profileName);
        out.newLine();
        for (String s : lines) {
            out.write(s);
            out.newLine();
    ...
    public static void editProfile(int userID, String firstname, String lastname, String gender, String dose,
        ...
        for (String s : lines) {
            if (s.split(" ")[1].equals(username)) {
                out.write(userID + " " + username + " " + firstname + " " + lastname + " " + gender + " " + dose + " "
                        + vaccinatedDate + " " + profileFileName);
                out.newLine();
            } else {
                out.write(s);
                out.newLine();
